...
class ShopDetait extends StatefulWidget {
  ...
  const ShopDetait({Key? key}) : super(key: key);
...
// class ProductDetailteis extends StatelessWidget {
//   final ProductModel productModel;
//
//   const ProductDetailteis({Key? key, required this.productModel})
//       : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
