...
class ShowReceiptPage extends StatefulWidget {
  const ShowReceiptPage({Key? key, required this.exchangemodel}) : super(key: key);

  final ExchangeModel exchangemodel;

  @override
  State<ShowReceiptPage> createState() => _ShowReceiptPageState();
}
...
var sts =true;
  ...
  Future<Null> showreceipts() async {
    String url = API.BASE_URL +
        '/kongkao/showreceiptsshop.php?isAdd=true&idshop=$userid&exchange_id=${widget.exchangemodel.exchangeid}';
