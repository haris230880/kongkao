...
class _BodyHomePageState extends State<BodyHomePage> {
  get so => LatLng(7.172030518071339, 100.61371720296158);
  get dd => LatLng(7.1666954052563, 100.60906690513322);
      ...
      child: SingleChildScrollView(
        child: Container(
          ...
          child: GoogleMap(
            ...
            markers:{
              Marker(markerId: MarkerId('so'),
              position: so,
              ),
              Marker(markerId: MarkerId('dd'),
                position: dd,
              ),
            },
          ),
